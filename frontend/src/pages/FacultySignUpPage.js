...
const SignupCard = styled(Card)(({ theme }) => ({
  ...
  '&::before': {
    ...
    right: 0,
    height: '8px',
    background: 'linear-gradient(90deg, #3498db, #8E24AA)',
  }
}));
...
const SubmitButton = styled(Button)(({ theme }) => ({
  ...
  textTransform: 'none',
  boxShadow: `0 5px 15px ${alpha('#8E24AA', 0.3)}`,
  ...
  '&:hover': {
    ...
    boxShadow: `0 8px 20px ${alpha('#8E24AA', 0.4)}`,
  }
}));
    ...
    <PageContainer>
      <SignupCard>
        <CardContent sx={{ p: 4 }}>
          ...
          >
            Create your faculty account to access CUMA
          </Typography>
      ...
      >
        <Alert 
          ...
          sx={{ width: '100%' }}
        >
          You have successfully signed up as faculty!
        </Alert>
      </Snackbar>
    </PageContainer>
  );
